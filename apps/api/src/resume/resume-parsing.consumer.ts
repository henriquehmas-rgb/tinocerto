...
export class ResumeParsingConsumer implements OnModuleInit, OnModuleDestroy {
  ...
  // este hook automaticamente em app.close()/shutdown. Sinaliza o laço e
  // ESPERA ele notar (consumeLoopPromise) antes de fechar o Redis -- na
  // ordem inversa, a volta em andamento do laço bateria num socket já
  // fechado. Se onModuleInit nunca rodou (testes que instanciam a classe
  // direto e só chamam handleResumeUploaded/processBatch),
